...
- Ausrüstung anlegen/ablegen mit Körperteil-Regeln (1 Kopf, 1 Rüstung, 1 Schuhwerk, max. 2 Hände) - und mit dem gedruckten Zeitpunkt: **nicht mitten im Kampf** (davor und danach jederzeit, auch im fremden Zug)
- Gegenstände verkaufen (1.000 Goldstücke = 1 Stufe; anders als das Anlegen nur im **eigenen Zug** und nicht im Kampf), inkl. Machtgruppe Alchemist ("Blei zu Gold": mind. 300 GS pro Gegenstand)
